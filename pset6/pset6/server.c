    ...
    while (true)
    {
        ...
        if (connected())
        {
            ...
            *httpptr = '\0';
            ...
            // if HTTP-version is not HTTP/1.1, yell at user
            ...
            // DONE: in 221-228 lines: char* extension points to path's extension
